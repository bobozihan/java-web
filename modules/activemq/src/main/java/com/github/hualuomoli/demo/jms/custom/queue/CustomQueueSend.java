package com.github.hualuomoli.demo.jms.custom.queue;
 ...
 *
 */
public class CustomQueueSend {

	public static void main(String[] args) {
		CustomQueueSend send = new CustomQueueSend();
		String msg = "queue";
	...
	public void sendMessage(String msg) {
		...
		String subject = "JMS.CUSTOM.QUEUE";
		// 1. 初始化连接工厂
